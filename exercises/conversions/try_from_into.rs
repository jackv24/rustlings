...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        let red = u8::try_from(tuple.0).expect("error");
        let green = u8::try_from(tuple.1).expect("error");
        let blue = u8::try_from(tuple.2).expect("error");
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        let red = u8::try_from(arr[0]).expect("error");
        let green = u8::try_from(arr[1]).expect("error");
        let blue = u8::try_from(arr[2]).expect("error");
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        let red = u8::try_from(slice[0]).expect("error");
        let green = u8::try_from(slice[1]).expect("error");
        let blue = u8::try_from(slice[2]).expect("error");
